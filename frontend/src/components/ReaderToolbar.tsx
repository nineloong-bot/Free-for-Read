import { ChevronLeft, ChevronRight, Bookmark, Sparkles, Type } from 'lucide-react'
...
export function ReaderToolbar(props: Props) {
  const hasPrev = props.chapterIndex > 0
  ...
  return (
    <div className="bg-white border-t border-[#f0e8d9] px-5 py-2 flex items-center justify-between max-w-[640px] mx-auto rounded-t-xl shadow-[0_-2px_12px_rgba(0,0,0,0.04)]" data-testid="reader-toolbar">
      ...
      <div className="flex items-center gap-2">
        <button onClick={props.onAiToggle} className="w-9 h-9 rounded-lg border border-[#f0e8d9] bg-white flex items-center justify-center"><Sparkles size={16} stroke="#d4641a" /></button>
